...
// 5. Khởi tạo biến page mặc định
        String page = "/pages/DashboardPage/profileStaff.jsp";

// 6. Điều hướng giao diện
        switch (action) {
            case "edit":
                page = "/pages/ProfileManagementPage/changeProfileStaff.jsp";
                break;
            case "changepassword":
                page = "/pages/ProfileManagementPage/changePasswordStaff.jsp";
                break;
            ...
            case "changePassword":
                ...
                if (errorNewPass.isEmpty() && errorOldPass.isEmpty()) {
                    ...
                    if (success) {
                        ...
                        response.sendRedirect("profilestaff?action=changepassword");
                    }
                } else {
