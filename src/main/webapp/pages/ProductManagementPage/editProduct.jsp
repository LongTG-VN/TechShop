...
<div class="max-w-4xl mx-auto bg-white p-8 rounded-2xl shadow-xl border border-gray-100 mt-10">
    ...
    <div class="flex justify-between items-start border-b pb-6 mb-8">
        <div>
            ...
            <p class="text-gray-500 mt-1">Editing ID: <span class="font-mono font-bold text-blue-600">#${product.productId}</span></p>
        </div>
    ...
    <form action="productServlet" method="POST" class="space-y-8">
                    ...
                    <div>
                        ...
                        <div class="mt-2 flex gap-4">
                            ...
                            <label class="flex items-center gap-2 cursor-pointer">
                                ...
                                <span class="text-sm font-bold text-green-600 bg-green-50 px-3 py-0.5 rounded-full border border-green-100 uppercase">ACTIVE</span>
                            </label>
                            ...
                            <label class="flex items-center gap-2 cursor-pointer">
                                ...
                                <span class="text-sm font-bold text-red-600 bg-red-50 px-3 py-0.5 rounded-full border border-red-100 uppercase">INACTIVE</span>
                            </label>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-gray-50 p-6 rounded-xl space-y-6 border border-gray-100 shadow-inner">
                ...
                <div class="space-y-4">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-xs font-bold text-gray-400 uppercase">Originally Created</p>
                            <p class="text-sm font-bold text-gray-700">
                                ${product.createdAt} 
                                <span class="text-gray-400 font-normal">by User #${not empty product.createdBy ? product.createdBy : 'Admin'}</span>
                            </p>
                        </div>
                    </div>
                            ...
                            <p class="text-sm font-bold text-gray-700">
                                <c:choose>
                                    <c:when test="${not empty product.updatedAt}">
                                        ${product.updatedAt} <span class="text-gray-400 font-normal ml-1">by User #${not empty product.updatedBy ? product.updatedBy : 'None'}</span>
                                    </c:when>
                                    <c:otherwise><span class="text-gray-400 italic font-normal">None</span></c:otherwise>
                                </c:choose>
                            </p>
                        </div>
                    </div>
        ...
        <div class="mt-10 pt-8 border-t">
            <label class="text-xs font-bold text-gray-400 uppercase tracking-widest">Product Description</label>
        ...
        <div class="mt-10 flex justify-end gap-4">
            <button type="button" onclick="window.history.back()" class="px-6 py-2.5 text-gray-500 font-bold hover:bg-gray-100 rounded-lg transition-all">
                Cancel
            </button>
            <button type="submit" class="px-10 py-2.5 bg-blue-600 text-white font-bold rounded-lg hover:bg-blue-700 shadow-lg shadow-blue-200 transition-all flex items-center gap-2 transform hover:-translate-y-0.5">
