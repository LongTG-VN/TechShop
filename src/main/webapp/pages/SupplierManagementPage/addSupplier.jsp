...
<div class="max-w-2xl mx-auto bg-white p-8 rounded-2xl shadow-xl border border-gray-100 mt-6">
    <div class="flex justify-between items-start border-b pb-6 mb-8">
        <div>
            <h2 class="text-2xl font-extrabold text-gray-900 uppercase tracking-tight">Add New Supplier</h2>
            <p class="text-gray-500 mt-1">Điền thông tin nhà cung cấp mới</p>
        </div>
    ...
    <form action="supplier" method="POST" class="space-y-6">
        ...
        <div>
            ...
            <input type="tel" name="phone" required maxlength="10" pattern="[0-9]{10}" inputmode="numeric" title="Nhập đúng 10 chữ số"
                   class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none"
        ...
        <div class="flex gap-3 pt-4">
            ...
            <a href="staffservlet?action=supplierManagement" class="inline-flex items-center gap-2 px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-700 rounded-full font-medium">
