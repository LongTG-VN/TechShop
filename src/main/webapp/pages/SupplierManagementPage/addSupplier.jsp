    ...
    <div class="max-w-2xl mx-auto bg-white p-8 rounded-2xl shadow-xl border border-gray-100 mt-6">
        ...
        <form action="supplier" method="POST" class="space-y-6">
            ...
            <div class="flex gap-3 pt-4">
                ...
                <button type="submit"
                        class="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-full font-medium">
                    Add
                </button>


                <a href="staffservlet?action=supplierManagement"
                   class="inline-flex items-center justify-center px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-700 rounded-full font-medium">
                    Cancel
                </a>
