...
<div class="max-w-2xl mx-auto bg-white p-8 rounded-xl shadow-md border border-gray-100 mt-10">
    <h2 class="text-2xl font-bold mb-6 text-gray-800 uppercase tracking-wide">Detailed Information</h2>

    <div class="space-y-6">
        <div class="grid grid-cols-12 gap-4 mb-4">
            <div class="col-span-3">
                <label class="block mb-2 text-sm font-medium text-gray-700">Category ID</label>
                <input type="text" value="#${category.categoryId}" 
        ...
        <div class="mb-4">
            ...
            <div class="flex gap-4 p-2 bg-gray-50 rounded-lg w-fit border border-gray-100">
                <label class="flex items-center cursor-not-allowed">
                    ...
                    <span class="ml-2 text-sm font-medium ${category.isActive ? 'text-green-600' : 'text-gray-400'}">
                        Active
                    </span>
                </label>
                <label class="flex items-center cursor-not-allowed">
                    <input type="radio" name="isActive" value="false" 
                           ${!category.isActive ? 'checked' : ''} disabled
                           class="w-4 h-4 text-blue-600 border-gray-300"> 
                    <span class="ml-2 text-sm font-medium ${!category.isActive ? 'text-red-600' : 'text-gray-400'}">
                        Inactive
                    </span>
                </label>
            </div>
