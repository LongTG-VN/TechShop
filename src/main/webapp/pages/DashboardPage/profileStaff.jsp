                    ...
                    <div class="p-6">
                        <div class="flex flex-col items-center">
                            ...
                            <nav class="w-full space-y-1">
                                <a href="profilestaff" class="bg-blue-50 text-blue-700 group flex items-center px-3 py-2 text-sm font-medium rounded-md">
                                ...
                                <a href="profilestaff?action=changepassword" class="text-gray-600 hover:bg-gray-50 hover:text-gray-900 group flex items-center px-3 py-2 text-sm font-medium rounded-md transition-colors">
            ...
            <div class="lg:col-span-8 xl:col-span-9 space-y-6">
                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="px-6 py-5 border-b border-gray-200 flex justify-between items-center">
                        ...
                        <a href="profilestaff?action=edit" class="text-sm text-blue-600 hover:text-blue-800 font-medium">Edit Info</a>
                    </div>
                    <div class="px-6 py-5">
