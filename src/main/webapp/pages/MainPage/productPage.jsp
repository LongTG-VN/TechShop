                ...
                <c:forEach var="p" items="${productList}">
                    <div
                        ...
                        <div
                            ...
                            <img src="${empty p.thumbnailUrl ? pageContext.request.contextPath.concat('/assets/img/product/iphone-15-blue.jpg') : pageContext.request.contextPath.concat('/').concat(p.thumbnailUrl)}"
                                 alt="${p.name}"
